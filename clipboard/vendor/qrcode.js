/* QRCode for JavaScript, Kazuhiko Arase; bundled from qrcode-terminal. See LICENSES.txt. */
...
};const cache={};function require(id){if(cache[id])return cache[id].exports;const module={exports:{}};cache[id]=module;modules[id](require,module,module.exports);return module.exports}window.LocalQRCode=require("./index");})();