...
public class FlowRulesTest {
    ...
    @Test public void detectsMaskedRowsWhenWebViewHidesEveryHeader(){assertEquals(FlowRules.Step.LIST,FlowRules.detect(FlowRules.Platform.MAOYAN,set("*忠友","身份证 430***********010","*一丹","身份证 511***********724")));assertEquals(FlowRules.Step.LIST,FlowRules.detect(FlowRules.Platform.PIAOXINGQIU,set("*龙","身份证 320***********631")));}
