...
public class FlowRulesTest {
    ...
    @Test public void detectsMaoyanListWithExistingPeopleAndSplitButton(){assertEquals(FlowRules.Step.LIST,FlowRules.detect(FlowRules.Platform.MAOYAN,set("常用信息","观演人信息","添加 /","修改观演人信息","*张蕊","身份证 530***********065")));}
    @Test public void detectsOldPersonListsAcrossWebViews(){assertEquals(FlowRules.Step.LIST,FlowRules.detect(FlowRules.Platform.MAOYAN,set("常用信息","*张蕊","身份证 530***********065")));assertEquals(FlowRules.Step.LIST,FlowRules.detect(FlowRules.Platform.PIAOXINGQIU,set("观演/赛人","*张蕊","身份证 530***********065")));}
    @Test public void maskedRowsAloneDoNotOverrideButtonFirstRouting(){assertEquals(FlowRules.Step.UNKNOWN,FlowRules.detect(FlowRules.Platform.MAOYAN,set("*忠友","身份证 430***********010","*一丹","身份证 511***********724")));assertEquals(FlowRules.Step.UNKNOWN,FlowRules.detect(FlowRules.Platform.PIAOXINGQIU,set("*龙","身份证 320***********631")));}
    @Test public void detectsFormsFromStructuralMarker(){assertEquals(FlowRules.Step.FORM,FlowRules.detect(FlowRules.Platform.MAOYAN,set("__forminputs__","确定")));assertEquals(FlowRules.Step.FORM,FlowRules.detect(FlowRules.Platform.PIAOXINGQIU,set("__forminputs__","保存")));}
    ...
    @Test public void bindsOnlyStrongPlatformFlowScreens(){assertTrue(FlowRules.identifiesPlatformFlow(FlowRules.Platform.PIAOXINGQIU,set("观演/赛人","陈梓涵","身份证 430**********0044","新增观演/赛人")));assertTrue(FlowRules.identifiesPlatformFlow(FlowRules.Platform.MAOYAN,set("常用信息","+ 添加 / 修改观演人信息")));assertFalse(FlowRules.identifiesPlatformFlow(FlowRules.Platform.PIAOXINGQIU,set("我的","保存")));assertFalse(FlowRules.identifiesPlatformFlow(FlowRules.Platform.MAOYAN,set("姓名","身份证")));}
}
